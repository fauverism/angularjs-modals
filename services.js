services.factory('PopupService', function ($http, $compile) {
    ...
    popupService.load = function(url, scope, options) {
        var htmlPage = '<div class="modal-header"><h3>Header</h3></div><div class="modal-body"><input type="text" ng-model="test"></div><div class="modal-footer"><button class="btn btn-primary" ng-click="doIt()">Do it</button><button class="btn btn-cancel" ng-click="cancel()">Cancel</button></div>';
